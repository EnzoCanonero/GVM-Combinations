...
![Central Values](output/decorrelated_cv.png)
![Confidence Interval](output/decorrelated_ci.png)
![Goodness of Fit](output/decorrelated_gof.png)
...
![Central Values](output/diag_cv.png)
![Confidence Interval](output/diag_ci.png)
![Goodness of Fit](output/diag_gof.png)
...
plt.show()
```
![Central Values](output/full_cv.png)
![Confidence Interval](output/full_ci.png)
![Goodness of Fit](output/full_gof.png)
...
plt.show()
```
![Central Values](output/hybrid_cv.png)
![Confidence Interval](output/hybrid_ci.png)
![Goodness of Fit](output/hybrid_gof.png)
